...
<div class="header-container">
  <img src="./app/static/hero.png" alt="ProjectCrafter" class="header-image">
  <div class="header-text">
    <h2>ProjectCrafter™</h2>
    <p>Crafting Clarity, Efficiency, and Success in Every Project</p>
  </div>
</div>
""",
